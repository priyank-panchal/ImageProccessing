...
public class Regex {
    ...
    static Pattern partyName1 = Pattern.compile("(?<=Bill\\n|ordernr\\n|ordernr\\r\\n)[^\\r\\n]+",Pattern.CASE_INSENSITIVE);
    ...
    static Pattern IGST = Pattern.compile("(?<=IGST Payable|IGST|Total Amount GST|Taxable Amount).+", Pattern.CASE_INSENSITIVE);
